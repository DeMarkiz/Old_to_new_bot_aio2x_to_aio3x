...
@pytest.mark.asyncio
async def test_get_user_by_telegram_id(user_service, test_user):
...
@pytest.mark.asyncio
async def test_get_all_users(user_service, test_user):
...
@pytest.mark.asyncio
async def test_get_active_users(user_service, test_user):
...
@pytest.mark.asyncio
async def test_get_user_by_telegram_id_not_found(user_service):
